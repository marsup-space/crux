...
Map<String, LspActorFactory> defaultLspActorFactories() => {
      ...
      'vue': () => WhichServerActor(
            ...
            install: npmInstaller('@vue/language-server',
                'vue-language-server'),
          ),
      ...
      'dockerfile': () => WhichServerActor(
            ...
            install: npmInstaller('dockerfile-language-server-nodejs',
                'docker-langserver'),
          ),
