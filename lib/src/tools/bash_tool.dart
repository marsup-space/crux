...
class BashTool extends ShellBase {
  ...
  String get description =>
      ...
      '  file inspection). '
      ''
      '❌ 🚨 CRITICAL: DO NOT USE Unless no other tool can satisfy the task. '
      ...
      'shell-quoting bugs. The bash+cat/sed/rg fallback is the #1 '
      'source of wasted tool calls in this codebase. '
      ''
      'EXAMPLES: '
