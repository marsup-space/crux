...
const Map<String, String> _en = {
  ...
  'sug.subagent.workers': 'Dispatch agents to do the hands-on work',
  'sug.subagent.experts': 'Consult read-only expert advisors',
  'sug.subagent.on': 'Enable this switch',
  'sug.subagent.off': 'Disable this switch',
  ...
  'chat.vibe.agents': 'agents',
  'chat.agent.spawned': 'spawned',
  'chat.agent.assigned': 'assigned',
  'chat.agent.sent': 'sent',
  'chat.agent.cancelled': 'cancelled',
  'chat.agent.read': 'read',
  'chat.agent.reported': 'reported',
  'chat.agent.asked': 'asked',
  'chat.agent.lateReplay':
      '[late delivery of history created {time} — not new progress]',
  'subagent.tooltip.domain': 'Domain: {domain}',
  'subagent.tooltip.task': 'Task: {task}',
  'subagent.tooltip.noActiveTask': 'No active task',
  'subagent.tooltip.intent': 'Intent: {intent}',
  'subagent.tooltip.model': 'Model: {model}',
  'subagent.tooltip.context': 'Context: {used} / {capacity} ({percent}%)',
  'subagent.tooltip.contextUnavailable': 'Context: unavailable',
  'subagent.tooltip.statusReady': 'Status: idle',
  'subagent.tooltip.statusQueued': 'Status: queued — waiting for model slot',
  'subagent.tooltip.statusBusy': 'Status: running',
  'subagent.tooltip.statusIdleLastIntent': 'Intent: {intent} (previous task)',
  'cmd.subagent.desc':
      'Toggle subagent mode (workers|experts on|off — independent switches)',
  'subagent.cmd.unavailable': 'Subagent mode is unavailable',
  'subagent.cmd.workersOn': 'Workers ON — dispatch work to agents',
  ...
  'subagent.pool.empty': 'no agents yet — hire via the main agent',
  'subagent.pool.busy': 'busy',
...
const Map<String, String> _zh = {
  ...
  'sug.subagent.workers': '把动手的活派给 agent 执行',
  'sug.subagent.experts': '请教只读专家顾问',
  'sug.subagent.on': '开启此开关',
  'sug.subagent.off': '关闭此开关',
  ...
  'chat.vibe.tools': '工具',
  'chat.vibe.files': '文件',
  'chat.vibe.agents': '智能体',
  'chat.agent.spawned': '创建了',
  'chat.agent.assigned': '派发了',
  'chat.agent.sent': '发送了',
  'chat.agent.cancelled': '取消了',
  'chat.agent.read': '读取了',
  'chat.agent.reported': '汇报了',
  'chat.agent.asked': '询问了',
  'chat.agent.lateReplay': '【历史补投 · 原始时间 {time}，非新进展】',
  'subagent.tooltip.domain': '领域：{domain}',
  'subagent.tooltip.task': '任务：{task}',
  'subagent.tooltip.noActiveTask': '暂无当前任务',
  'subagent.tooltip.intent': '意图：{intent}',
  'subagent.tooltip.model': '模型：{model}',
  'subagent.tooltip.context': '上下文：{used} / {capacity}（{percent}%）',
  'subagent.tooltip.contextUnavailable': '上下文：暂无数据',
  'subagent.tooltip.statusReady': '状态：空闲',
  'subagent.tooltip.statusQueued': '状态：排队中，等待模型槽位',
  'subagent.tooltip.statusBusy': '状态：正在执行',
  'subagent.tooltip.statusIdleLastIntent': '意图：{intent}（上次任务）',
  'cmd.subagent.desc': '切换 subagent 模式（workers|experts on|off——两个独立开关）',
  'subagent.cmd.unavailable': 'Subagent 模式不可用',
  'subagent.cmd.workersOn': 'Workers 已开启——把工作派发给 agent',
  'subagent.cmd.workersOff': 'Workers 已关闭——主 agent 自己动手',
  'subagent.cmd.expertsOn': 'Experts 已开启——可请教只读专家',
  'subagent.cmd.expertsOff': 'Experts 已关闭',
  'subagent.cmd.persistFailed': 'Subagent 模式已切换，但配置保存失败',
  'subagent.bar.workers': 'workers',
  'subagent.bar.experts': 'experts',
  'home.title.agents': '智能体',
  'subagent.pool.empty': '还没有 agent——让主 agent hire 一个',
  'subagent.pool.busy': '执行中',
