...
void main() {
  test('/language reports, rejects unknown codes, switches, and persists', () async {
    ...
    final controller = await LocaleController.create(configStore: configStore);
  ...
  test('/reply-language reports, rejects unknown codes, switches, and persists',
      () async {
    final directory = await Directory.systemTemp.createTemp(
    ...
    expect(toasts.last.$1, contains('Current reply language: Follow language'));
