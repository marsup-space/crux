...
- `CRUX_VERSION=v0.10.1` 锁定版本（默认 `latest`）
...
- `CRUX_VERSION=v0.10.1` — pin a version (default: `latest`)
...
Current version: **0.10.1**. Crux is now considered usable for daily work, while still moving quickly.
