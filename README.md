...
- `CRUX_VERSION=v0.9.0` 锁定版本（默认 `latest`）
...
- `CRUX_VERSION=v0.9.0` — pin a version (default: `latest`)
...
Current version: **0.9.0**. Crux is now considered usable for daily work, while still moving quickly.
